namespace Pis_Big_Project
{
    partial class Baton
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Baton));
            ...
            this.батончикBindingNavigator = new System.Windows.Forms.BindingNavigator(this.components);
            ...
            this.батончикBindingNavigatorSaveItem = new System.Windows.Forms.ToolStripButton();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.батончикBindingNavigator)).BeginInit();
            this.батончикBindingNavigator.SuspendLayout();
            ...
            // 
            // батончикBindingNavigator
            // 
            this.батончикBindingNavigator.AddNewItem = this.bindingNavigatorAddNewItem;
            this.батончикBindingNavigator.BindingSource = this.батончикBindingSource;
            this.батончикBindingNavigator.CountItem = this.bindingNavigatorCountItem;
            this.батончикBindingNavigator.DeleteItem = this.bindingNavigatorDeleteItem;
            this.батончикBindingNavigator.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            ...
            this.батончикBindingNavigatorSaveItem});
            this.батончикBindingNavigator.Location = new System.Drawing.Point(0, 0);
            this.батончикBindingNavigator.MoveFirstItem = this.bindingNavigatorMoveFirstItem;
            this.батончикBindingNavigator.MoveLastItem = this.bindingNavigatorMoveLastItem;
            this.батончикBindingNavigator.MoveNextItem = this.bindingNavigatorMoveNextItem;
            this.батончикBindingNavigator.MovePreviousItem = this.bindingNavigatorMovePreviousItem;
            this.батончикBindingNavigator.Name = "батончикBindingNavigator";
            this.батончикBindingNavigator.PositionItem = this.bindingNavigatorPositionItem;
            this.батончикBindingNavigator.Size = new System.Drawing.Size(800, 25);
            this.батончикBindingNavigator.TabIndex = 0;
            this.батончикBindingNavigator.Text = "bindingNavigator1";
            // 
            ...
            // 
            // батончикBindingNavigatorSaveItem
            // 
            this.батончикBindingNavigatorSaveItem.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
            this.батончикBindingNavigatorSaveItem.Image = ((System.Drawing.Image)(resources.GetObject("батончикBindingNavigatorSaveItem.Image")));
            this.батончикBindingNavigatorSaveItem.Name = "батончикBindingNavigatorSaveItem";
            this.батончикBindingNavigatorSaveItem.Size = new System.Drawing.Size(23, 23);
            this.батончикBindingNavigatorSaveItem.Text = "Сохранить данные";
            this.батончикBindingNavigatorSaveItem.Click += new System.EventHandler(this.БатончикBindingNavigatorSaveItem_Click);
            // 
            ...
            this.батончикDataGridView.Location = new System.Drawing.Point(12, 28);
            this.батончикDataGridView.Name = "батончикDataGridView";
            this.батончикDataGridView.Size = new System.Drawing.Size(753, 189);
            ...
            this.Controls.Add(this.батончикBindingNavigator);
            this.Name = "Baton";
            this.Text = "Baton";
            ...
            ((System.ComponentModel.ISupportInitialize)(this.батончикBindingNavigator)).EndInit();
            this.батончикBindingNavigator.ResumeLayout(false);
            this.батончикBindingNavigator.PerformLayout();
        ...
        private System.Windows.Forms.BindingNavigator батончикBindingNavigator;
        ...
        private System.Windows.Forms.ToolStripButton батончикBindingNavigatorSaveItem;
